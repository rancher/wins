...
replace (
	...
	k8s.io/kubernetes => k8s.io/kubernetes v1.34.10
	k8s.io/legacy-cloud-providers => k8s.io/legacy-cloud-providers v0.34.9
...
require (
	...
	github.com/rancher/system-agent v0.13.1-rc.0
...
require (
	...
	k8s.io/cloud-provider v0.34.10 // indirect
