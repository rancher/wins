...
replace (
	...
	github.com/klauspost/compress => github.com/klauspost/compress v1.18.7
	...
	k8s.io/legacy-cloud-providers => k8s.io/legacy-cloud-providers v0.33.13
...
require (
	...
	k8s.io/cri-client v0.33.13 // indirect
